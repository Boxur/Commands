...
int main(int argc, char *argv[]) {
  ...
  console["set"]["newLineAutoComplete"]["1"].function =
      console["set"]["newLineAutoComplete"]["true"].function =
          [&](const std::vector<std::string> &) {
            console.settings.newLineAutoComplete = true;
            std::cout << "newLineAutoComplete was set to true" << std::endl;
          };

  console["set"]["newLineAutoComplete"]["0"].function =
      console["set"]["newLineAutoComplete"]["false"].function =
          [&](const std::vector<std::string> &) {
  ...
  console["set"]["newLineAutoComplete"]["show"].function =
      [&](const std::vector<std::string> &) {
        std::cout << "newLineAutoComplete is set to "
                  << ((console.settings.newLineAutoComplete) ? "true" : "false")
                  << std::endl;
      };
  ...
  console["set"]["histSize"].function =
      [&](const std::vector<std::string> &args) {
        ...
        std::cout << "histSize was set to " << console.settings.histSize
                  << std::endl;
      };

  console["exit"].function = [&](const std::vector<std::string> &) {
    console.stop = true;
  };
